...
const BlogSkeleton = () => {
  return (
    <div role="status" className="max-w-3xl animate-pulse p-6 mx-auto">
      ...
      <div className="flex items-center justify-center h-80 mb-8 bg-gray-300 rounded dark:bg-gray-400">
        <svg
      ...
      <div className="space-y-4">
        <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-400 w-48" />
